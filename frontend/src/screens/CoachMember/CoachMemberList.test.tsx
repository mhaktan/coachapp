...
import { CoachMemberList } from './CoachMemberList';
...
describe('CoachMemberList', () => {
  it('should render without crashing', () => {
    const { container } = render(<CoachMemberList />, { wrapper });
    expect(container).toBeDefined();
  });

  it('should show title', () => {
    render(<CoachMemberList />, { wrapper });
    expect(screen.getByText('CoachMember')).toBeDefined();
  });

  it('should have create button', () => {
    render(<CoachMemberList />, { wrapper });
    expect(screen.getByText('+ Create CoachMember')).toBeDefined();
  });
