...
import { SessionPackageList } from './SessionPackageList';
...
describe('SessionPackageList', () => {
  it('should render without crashing', () => {
    const { container } = render(<SessionPackageList />, { wrapper });
    expect(container).toBeDefined();
  });

  it('should show title', () => {
    render(<SessionPackageList />, { wrapper });
    expect(screen.getByText('SessionPackage')).toBeDefined();
  });

  it('should have create button', () => {
    render(<SessionPackageList />, { wrapper });
    expect(screen.getByText('+ Create SessionPackage')).toBeDefined();
  });
