...
const COLUMNS: TableColumn[] = [
  ...
  { field: 'status', header: 'Status', sortable: true, filterType: 'radio', filterOptions: [{ label: 'Planned', value: '0' }, { label: 'Completed', value: '1' }, { label: 'Cancelled', value: '2' }], html: (row: Record<string, unknown>) => { const m: Record<string, string> = {'0': 'Planned', '1': 'Completed', '2': 'Cancelled'}; return m[String(row.status ?? '')] ?? String(row.status ?? '\u2014'); } },
